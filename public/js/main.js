...
function addHaltes (targetMap) {
    var dataUrl = 'http://172.20.0.1:8080/haltes';
    var mapviewEl = document.querySelector('[data-mapview]');
    var embedded = mapviewEl.getAttribute('data-embedded');
    axios.get(dataUrl)
        .then(function (response) {
...
function addParkeren (targetMap) {
    var dataUrl = 'http://172.20.0.1:8080/parkeerplaatsen';
    var mapviewEl = document.querySelector('[data-mapview]');
    var embedded = mapviewEl.getAttribute('data-embedded');
    axios.get(dataUrl)
        .then(function (response) {
...
function addBestemmingsverkeer (targetMap) {
    var dataUrl = 'http://172.20.0.1:8080/routes/roadwork/geojson';
    axios.get(dataUrl)
        .then(function (response) {
            res = response.data;
            var styles = {
...
function addAanbevolenroutes (targetMap) {
    var dataUrl = 'http://172.20.0.1:8080/routes/recommended/geojson';
    axios.get(dataUrl)
        .then(function (response) {
            res = response.data;
            var styles = {
...
function addVerplichteroutes(targetMap) {
    var dataUrl = 'http://172.20.0.1:8080/routes/mandatory/geojson';
    axios.get(dataUrl)
        .then(function (response) {
            res = response.data;
            var styles = {
